...
class GetRecentCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return Movie::class === $resourceClass && 'get_recents' === $operationName;
    }
